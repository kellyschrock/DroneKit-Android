...
class VTOLLandImpl : MissionCMD {
    ...
    constructor(mission: Mission?, approachAltitude: Double, yawAngle: Double, lat: Double, lng: Double, alt: Double) : super(mission) {
    ...
    override fun packMissionItem(): List<msg_mission_item> {
        ...
        mavMsg.param1 = 0f
        mavMsg.param2 = 0f
        mavMsg.param3 = approachAltitude.toFloat()
    ...
    override fun unpackMAVMessage(mavMsg: msg_mission_item) {
        approachAltitude = mavMsg.param3.toDouble()
    ...
    override fun getType(): MissionItemType = MissionItemType.VTOL_LAND
