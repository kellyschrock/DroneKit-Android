...
object SpannableUtils {
    ...
    private fun apply(content: Array<CharSequence>, vararg tags: Any): CharSequence {
        ...
        openTags(text, tags)
        content.forEach { item -> text.append(item) }
        closeTags(text, tags)
        return text
    }
    ...
    fun bold(vararg content: CharSequence): CharSequence {
        return apply(content as Array<CharSequence>, StyleSpan(Typeface.BOLD))
    }
    ...
    fun italic(vararg content: CharSequence): CharSequence {
        return apply(content as Array<CharSequence>, StyleSpan(Typeface.ITALIC))
    }
    ...
    fun normal(vararg content: CharSequence): CharSequence {
        return apply(content as Array<CharSequence>, StyleSpan(Typeface.NORMAL))
    }
    ...
    fun color(color: Int, vararg content: CharSequence): CharSequence {
        return apply(content as Array<CharSequence>, ForegroundColorSpan(color))
    }
}
