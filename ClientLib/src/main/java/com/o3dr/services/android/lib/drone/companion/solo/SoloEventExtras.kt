 ...
 */
object SoloEventExtras {
    private const val PACKAGE_NAME = "com.o3dr.services.android.lib.drone.companion.solo.event.extra"

    /**
     * Used to retrieve the [com.o3dr.services.android.lib.drone.companion.solo.button.ButtonPacket] object describing the button event.
     */
    const val EXTRA_SOLO_BUTTON_EVENT = PACKAGE_NAME + ".EXTRA_SOLO_BUTTON_EVENT"

    /**
     * Used to retrieve the received sololink message data in bytes.
     */
    const val EXTRA_SOLO_MESSAGE_DATA = PACKAGE_NAME + ".EXTRA_SOLO_MESSAGE_DATA"
     ...
     */
    const val EXTRA_SOLO_TX_POWER_COMPLIANT_COUNTRY = PACKAGE_NAME + ".EXTRA_SOLO_TX_POWER_COMPLIANT_COUNTRY"

    /**
     * Used to retrieve the solo controller version.
     * @see {@link SoloEvents.SOLO_VERSIONS_UPDATED}
     */
    const val EXTRA_SOLO_CONTROLLER_VERSION = PACKAGE_NAME + ".EXTRA_SOLO_CONTROLLER_VERSION"

    /**
     * Used to retrieve the solo controller firmware version.
     * @see {@link SoloEvents.SOLO_VERSIONS_UPDATED}
     */
    const val EXTRA_SOLO_CONTROLLER_FIRMWARE_VERSION = PACKAGE_NAME + ".EXTRA_SOLO_CONTROLLER_FIRMWARE_VERSION"

    /**
     * Used to retrieve the solo vehicle version.
     * @see {@link SoloEvents.SOLO_VERSIONS_UPDATED}
     */
    const val EXTRA_SOLO_VEHICLE_VERSION = PACKAGE_NAME + ".EXTRA_SOLO_VEHICLE_VERSION"

    /**
     * Used to retrieve the solo autopilot version.
     * @see {@link SoloEvents.SOLO_VERSIONS_UPDATED}
     */
    const val EXTRA_SOLO_AUTOPILOT_VERSION = PACKAGE_NAME + ".EXTRA_SOLO_AUTOPILOT_VERSION"

    /**
     * Used to retrieve the solo gimbal version.
     * @see {@link SoloEvents.SOLO_VERSIONS_UPDATED}
     */
    const val EXTRA_SOLO_GIMBAL_VERSION = PACKAGE_NAME + ".EXTRA_SOLO_GIMBAL_VERSION"
     ...
     */
    const val EXTRA_SOLO_CONTROLLER_MODE = PACKAGE_NAME + ".EXTRA_SOLO_CONTROLLER_MODE"
     ...
     */
    const val EXTRA_SOLO_CONTROLLER_UNIT = PACKAGE_NAME + ".EXTRA_SOLO_CONTROLLER_UNIT"
}
