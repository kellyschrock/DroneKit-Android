...
public class msg_gps_accuracy extends MAVLinkMessage{
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_GPS_ACCURACY - sysid:"+sysid+" compid:"+compid+" h_acc:"+h_acc+" s_acc:"+s_acc+" h_vel_filt:"+h_vel_filt+" v_vel_filt:"+v_vel_filt+" p_drift:"+p_drift+" instance:"+instance+" ekf_check_mask:"+ekf_check_mask+"";
    }
}
